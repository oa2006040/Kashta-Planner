        ...
        <div className="relative z-10 space-y-3 sm:space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <h1 className="text-xl sm:text-2xl font-bold">أهلاً بك في كشتة</h1>
          ...
          <>
              ...
              <CardContent className="p-3 sm:p-6">
                <div className="flex items-start justify-between gap-2 sm:gap-4">
                  <div className="space-y-1 sm:space-y-2 min-w-0">
                    <p className="text-xs sm:text-sm text-muted-foreground">إجمالي الطلعات</p>
            ...
            <Card className="relative overflow-visible">
              <CardContent className="p-3 sm:p-6">
                <div className="flex items-start justify-between gap-2 sm:gap-4">
                  <div className="space-y-1 sm:space-y-2 min-w-0">
                    <p className="text-xs sm:text-sm text-muted-foreground">الديون المدفوعة</p>
            ...
            <Card className="relative overflow-visible">
              <CardContent className="p-3 sm:p-6">
                <div className="flex items-start justify-between gap-2 sm:gap-4">
                  <div className="space-y-1 sm:space-y-2 min-w-0">
                    <p className="text-xs sm:text-sm text-muted-foreground">الديون غير المدفوعة</p>
          ...
          {eventsLoading ? (
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg sm:text-xl font-semibold">الطلعات الجارية</h2>
              </div>
              <EventCardSkeleton />
              <EventCardSkeleton />
            </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center justify-between gap-2 sm:gap-4">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <h2 className="text-lg sm:text-xl font-semibold">الطلعات القادمة</h2>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center justify-between gap-2 sm:gap-4">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold">الطلعات المنتهية</h2>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center justify-between gap-2 sm:gap-4">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold">الطلعات الملغاة</h2>
            ...
            <CardContent className="p-3 sm:p-4">
              <div className="text-center space-y-2 sm:space-y-3">
                <div className="space-y-1">
                  <p className="text-[10px] sm:text-xs text-muted-foreground">التاريخ الهجري</p>
                  <p className="text-base sm:text-lg font-semibold">
                    {formatHijriDate(new Date())}
                  </p>
                </div>
                <div className="border-t border-border pt-2 sm:pt-3 space-y-1">
                  <p className="text-[10px] sm:text-xs text-muted-foreground">التاريخ الميلادي</p>
