...
export const DEFAULT_CATEGORIES = [
  {
    ...
    order: 1,
    items: [
      { name: 'دلة عربية', description: 'للقهوة السعودية', isCommon: true },
      { name: 'فناجين قهوة', description: 'طقم 12 فنجان', isCommon: true },
      { name: 'قهوة عربية مطحونة', description: 'مع الهيل والزعفران', isCommon: true },
  ...
  },
  {
    ...
    order: 5,
    items: [
      { name: 'فانوس LED', description: 'قابل للشحن', isCommon: true },
  ...
  },
  {
    ...
    order: 6,
    items: [
      { name: 'سيارة دفع رباعي', description: 'للطرق الوعرة', isCommon: true },
...
export const AVATAR_OPTIONS = [
  'user', 'user-circle', 'user-round', 'user-check', 'users', 'contact'
];
...
export const STATUS_COLORS = {
  upcoming: { bg: 'bg-blue-100 dark:bg-blue-900/30', text: 'text-blue-700 dark:text-blue-300', label: 'قادمة' },
  ongoing: { bg: 'bg-green-100 dark:bg-green-900/30', text: 'text-green-700 dark:text-green-300', label: 'جارية' },
  completed: { bg: 'bg-gray-100 dark:bg-gray-800/50', text: 'text-gray-700 dark:text-gray-300', label: 'منتهية' },
  cancelled: { bg: 'bg-red-100 dark:bg-red-900/30', text: 'text-red-700 dark:text-red-300', label: 'ملغاة' },
};
